...
```{r echo=FALSE}
DT::datatable(snaive_accuracy_10_weeks) %>% frameWidget(height = "100%", width = "100%")
...
```{r echo=FALSE}
DT::datatable(snaive_accuracy_8_weeks) %>% frameWidget(height = "100%", width = "100%")
```
...
```{r echo=FALSE}
DT::datatable(tbats_accuracy_4_weeks) %>% frameWidget(height = "100%", width = "100%")
```
...
```{r echo=FALSE}
DT::datatable(tbats_accuracy_2_weeks) %>% frameWidget(height = "100%", width = "100%")
```
...
DT::datatable(accuracy(aemo_weekly_auto_arima)) %>% frameWidget(height = "100%", width = "100%")
```
